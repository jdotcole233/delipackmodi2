...
//    var context: UIViewController?
    var baseUrl: String = "http://192.168.100.6:8000/api/"
...
//                    alertDeliPack.hideLoaderAler()
    ...
    func networkRequestToServerHistory<T: Decodable>(requestEndpoint: String,
                                              requestMethod: String,
                                              requestData: [String: Any],
                                              dataModel: T.Type,
                                              completion: @escaping (_ history: [CustomerHistoryModel])->Void){
